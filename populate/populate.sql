...
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'xivo-call-logd', 'xivo-call-logd', substring(gen_salt('bf',4),8), '{confd.lines.read}');
...
INSERT INTO "infos" VALUES ('populate-uuid', '17.07');
