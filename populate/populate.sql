...
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'wazo-plugind-cli', 'wazo-plugind-cli', substring(gen_salt('bf',4),8), '{plugind.plugins.create, plugind.plugins.*.*.delete, plugind.plugins.read}');
...
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'xivo-call-logd', 'xivo-call-logd', substring(gen_salt('bf',4),8), '{confd.lines.read, confd.users.*.read}');
...
INSERT INTO "infos" VALUES ('populate-uuid', '17.12');
