...
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'asterisk', 'asterisk', substring(gen_salt('bf',4),8), '{auth.tenants.read, confd.voicemails.read, confd.voicemails.*.update}');
...
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'wazo-dird-xivo-backend', 'wazo-dird-xivo-backend', substring(gen_salt('bf',4),8), '{auth.tenants.read, confd.users.read, confd.infos.read}');
...
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'wazo-upgrade', 'wazo-upgrade', substring(gen_salt('bf',4),8), '{plugind.#,confd.#,auth.#}');
...
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'xivo-agid', 'xivo-agid', substring(gen_salt('bf',4),8), '{auth.tenants.read, dird.directories.reverse.*.*.read, agentd.#, confd.devices.read, confd.lines.read, confd.lines.*.devices.*.update, confd.devices.*.synchronize.read, confd.devices.*.autoprov.read, confd.users.*.services.*.*, confd.users.*.forwards.#}');
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'xivo-confd', 'xivo-confd', substring(gen_salt('bf',4),8), '{auth.users.#,auth.admin.#}');
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'xivo-ctid', 'xivo-ctid', substring(gen_salt('bf',4),8), '{auth.tenants.read, dird.#, agentd.#, confd.users.*.services.dnd.update, ctid-ng.#}');
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'xivo-ctid-ng', 'xivo-ctid-ng', substring(gen_salt('bf',4),8), '{auth.tenants.read, confd.#, amid.action.Redirect.create, amid.action.Setvar.create, amid.action.ShowDialplan.create, amid.action.Command.create, websocketd, websocketd.#, mongooseim.admin}');
...
INSERT INTO "directories" (
  ...
  NULL,
  '/var/lib/wazo-auth-keys/wazo-dird-xivo-backend-key.yml',
  'xivo_service',
  true,
...
INSERT INTO "infos" VALUES ('populate-uuid', '18.14');
