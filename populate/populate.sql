...
INSERT INTO "ctidisplays" VALUES(DEFAULT,'Display','{"10": [ "Nom","name","","name" ],"20": [ "Numéro","number","","phone" ], "30": [ "Mobile","callable","","phone_mobile" ], "40": ["Favoris", "favorite", "", "favorite"], "50": ["Personnel", "personal", "", ""]}',1,'Affichage par défaut');
