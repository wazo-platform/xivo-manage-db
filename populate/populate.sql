...
INSERT INTO "accesswebservice" (uuid, name, login, passwd, acl) VALUES (uuid_generate_v4(), 'wazo-plugind-cli', 'wazo-plugind-cli', substring(gen_salt('bf',4),8), '{plugind.plugins.create, plugind.plugind.*.*.delete}');
